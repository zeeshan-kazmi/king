...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev: zeeshan_hacker
	print logo
...
def pilih_super():
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mZEESHANHACKER\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;93m«---•◈•---Developed By ZEESHAN-Hacker--•◈•---»" #Dev: Zeeshan_hacker
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 zeeshan.py)↩\033[1;97m....'
